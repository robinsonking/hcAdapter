...
func (bs *HCBlockScanner) GetTransactionsByAddress(offset, limit int, coin openwallet.Coin, address ...string) ([]*openwallet.TxExtractData, error) {
...
//Run 运行
func (bs *HCBlockScanner) Run() error {
...
////Stop 停止扫描
func (bs *HCBlockScanner) Stop() error {
...
//
////Pause 暂停扫描
//func (bs *HCBlockScanner) Pause() error {
//	if bs.wm.Config.RPCServerType == RPCServerExplorer {
//		return nil
//	} else {
...
//
////Restart 继续扫描
//func (bs *HCBlockScanner) Restart() error {
//	if bs.wm.Config.RPCServerType == RPCServerExplorer {
//		return nil
//	} else {
...
func (bs *HCBlockScanner) connectSocketIO(disconnected chan struct{}) (*gosocketio.Client, error) {
...
func (bs *HCBlockScanner) setupSocketIO() error {
