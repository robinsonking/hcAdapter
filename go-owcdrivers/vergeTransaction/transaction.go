...
func CreateEmptyTransactionAndHash(vin []Vin, vout []Vout, lockTime, timeInterval uint32) (string, []string, error) {
	txStruct, err := NewTxStruct(vin, vout, timeInterval, lockTime)
	if err != nil {
		return "", nil, err
	}
