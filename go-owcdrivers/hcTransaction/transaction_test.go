...
func Test_case1(t *testing.T) {
	// 前置交易ID和UTXO对应的索引
	in := Vin{"090419def60eee3bd3663104fe294a5851b708b5a85c40d34c13ed242bd362b8", uint32(1)}
	// 目标地址和发送金额
	out := Vout{"HsXzQ6NWJXfr49zFsjBXxNtGTUynGov43NP", uint64(1)}
	...
	//[2]byte{0x09, 0x7f}
	addressPrefix := AddressPrefix{[]byte{0x09,0x7f}, []byte{0xc4}, "tb"}
...
//Hm38EKFdV2t1eFabQe1dGbnXixnPYe9WwDaZ7rdZWvJYgNjmuWSPk
	//签名
