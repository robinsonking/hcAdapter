...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO HC", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WBwcyqaRhUHNXcQcuXDaUiVmR2Ve5Jb6pa")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WBwcyqaRhUHNXcQcuXDaUiVmR2Ve5Jb6pa"
	account := &openwallet.AssetsAccount{Alias: "testnetHC-2", WalletID: walletID, Required: 1, Symbol: "HC", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WBwcyqaRhUHNXcQcuXDaUiVmR2Ve5Jb6pa"
	accountID := "GWapYoAQQtios1DRNexYMhCbyEK78Fc3KKpjbMaGkBV8"
