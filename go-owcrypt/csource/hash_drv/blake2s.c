...
static const uint32_ow blake2s_IV[8] =
{
    0x6A09E667U, 0xBB67AE85U, 0x3C6EF372U, 0xA54FF53AU,
    0x510E527FU, 0x9B05688CU, 0x1F83D9ABU, 0x5BE0CD19U
};

static const uint8_ow blake2s_sigma[10][16] =
{
...
static  uint32_ow load32(const uint8_ow *src)
{
    const union {
        long one;
        char little;
...
static  uint32_ow rotr32(const uint32_ow w, const unsigned int c)
{
    return (w >> c) | (w << (32 - c));
}
...
{
    const uint8_ow *p = (const uint8_ow *)(P);
    size_t i;
...
static void blake2s_compress(BLAKE2S_CTX *S,const uint8_ow *blocks,size_t len);
...
void blake2s_update(BLAKE2S_CTX *ctx, const uint8_ow *msg, uint32_ow mas_len)
{
    ...
    if (mas_len > fill)
    {
        ...
        {
            uint32_ow stashlen = mas_len % BLAKE2S_BLOCKBYTES;
            /*
...
void blake2s_final(BLAKE2S_CTX *ctx,uint8_ow *digest,uint32_ow digest_len)
{
    ...
    memcpy(digest, (uint8_ow *)&ctx->h[0], digest_len);
    //return 1;
}
